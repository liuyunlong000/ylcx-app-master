 ...
 * @Date: 2022-11-12 17:41:45
 * @LastEditors: vanC 418637966@qq.com?
 * @LastEditTime: 2022-11-13 18:30:55
 * @FilePath: \mars3d-vue2d:\IDATA\projects\idata-home\src\views\talent\components\dynamic.vue
...
<template>
  <div>
    <div class="news_list">
      <ul class="ul">
        <li class="cle" v-for="(item, index) in dynamicList" :key="index">
...
<script>
import {dynamic_list} from "@/api/wz/wzTalent";
...
export default {
  ...
  methods: {
    getDynamicList(){
      dynamic_list(this.queryForm).then((response) => {
